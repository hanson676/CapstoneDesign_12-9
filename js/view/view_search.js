...
function SearchView()
{
	...
	{ 
		...
		+			'<tr>'
		+				'<td width="10%" align="right" valign="middle"><div class="cls-buildingList-img" ><img src="./img/building_7.png" width="50" height="50"/></div></td>'
		+				'<td width="854" align="left" valign="middle"><h2>7호관</h2><p>전자정보통신대학 /<br/>삼림과학대학 / 체육대학</p></td>'
		+				'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+			'</tr>'
		+		'</table>'		   
		+	'</li>'		
		...
		+		'<table width="100%" border="0" cellpadding="5" cellspacing="0">'
		+			'<tr>'
		+				'<td width="10%" align="right" valign="middle"><div class="cls-buildingList-img" ><img src="./img/building_business.png" width="50" height="50"/></div></td>'
		+				'<td width="854" align="left" valign="middle"><h2>경상관</h2><p>경상대학 / 경영대학</p></td>'
		+				'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+			'</tr>'
		+		'</table>'		   
		+	'</li>'		
		...
		+		'<table width="100%" border="0" cellpadding="5" cellspacing="0">'
		+			'<tr>'
		+				'<td width="10%" align="right" valign="middle"><div class="cls-buildingList-img" ><img src="./img/building_engineering.png" width="50" height="50"/></div></td>'
		+				'<td width="854" align="left" valign="middle"><h2>공학관</h2><p>공과대학</p></td>'
		+				'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+			'</tr>'
		+		'</table>'		   
		+	'</li>'
		...
		+		'<table width="100%" border="0" cellpadding="5" cellspacing="0">'
		+			'<tr>'
		+				'<td width="10%" align="right" valign="middle"><div class="cls-buildingList-img" ><img src="./img/building_science.png" width="50" height="50"/></div></td>'
		+				'<td width="854" align="left" valign="middle"><h2>과학관</h2><p>자연과학대학</p></td>'
		+				'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+			'</tr>'
		+		'</table>'		   
		+	'</li>'
		...
		+		'<table width="100%" border="0" cellpadding="5" cellspacing="0">'
		+			'<tr>'
		+				'<td width="10%" align="right" valign="middle"><div class="cls-buildingList-img" ><img src="./img/building_international.png" width="50" height="50"/></div></td>'
		+				'<td width="854" align="left" valign="middle"> <h2>국제관</h2><p>경영대학 / 경상대학</p></td>'
		+				'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+			'</tr>'
		+		'</table>'		   
		+	'</li>'
		...
		+		'<table width="100%" border="0" cellpadding="5" cellspacing="0">'
		+			'<tr>'
		+				'<td width="10%" align="right" valign="middle"><div class="cls-buildingList-img" ><img src="./img/building_law.png" width="50" height="50"/></div></td>'
		+				'<td width="854" align="left" valign="middle"> <h2>법학관</h2><p>법학대학</p></td>'
		+				'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+			'</tr>'
		+		'</table>'		   
		+	'</li>'
		...
		+		'<table width="100%" border="0" cellpadding="5" cellspacing="0">'
		+			'<tr>'
		+				'<td width="10%" align="right" valign="middle"><div class="cls-buildingList-img" ><img src="./img/building_student_union.png" width="50" height="50"/></div></td>'
		+				'<td width="854" align="left" valign="middle"> <h2>복지관</h2><p>건축대학</p></td>'
		+				'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+			'</tr>'
		+		'</table>'		   
		+	'</li>'
		...
		+		'<table width="100%" border="0" cellpadding="5" cellspacing="0">'
		+			'<tr>'
		+				'<td width="10%" align="right" valign="middle"><div class="cls-buildingList-img" ><img src="./img/building_bugak.png" width="50" height="50"/></div></td>'
		+				'<td width="854" align="left" valign="middle"><h2>북악관</h2><p>문과대학 / 사회과학대학</p></td>'
		+				'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+			'</tr>'
		+		'</table>'		   
		+	'</li>'
		...
		+		'<table width="100%" border="0" cellpadding="5" cellspacing="0">'
		+			'<tr>'
		+				'<td width="10%" align="right" valign="middle"><div class="cls-buildingList-img" ><img src="./img/building_art.png" width="50" height="50"/></div></td>'
		+				'<td width="854" align="left" valign="middle"><h2>예술관</h2><p>예술대학</p></td>'
		+				'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+			'</tr>'
		+		'</table>'		   
		+	'</li>'
		...
		+		'<table width="100%" border="0" cellpadding="5" cellspacing="0">'
		+			'<tr>'
		+				'<td width="10%" align="right" valign="middle"><div class="cls-buildingList-img" ><img src="./img/building_design.png" width="50" height="50"/></div></td>'
		+				'<td width="854" align="left" valign="middle"><h2>조형관</h2><p>조형대학</p></td>'
		+				'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+			'</tr>'
		+		'</table>'		   
		+	'</li>'
		...
		+		'<table width="100%" border="0" cellpadding="5" cellspacing="0">'
		+			'<tr>'
		+				'<td width="10%" align="right" valign="middle"><div class="cls-buildingList-img" ><img src="./img/building_gymnasium.png" width="50" height="50"/></div></td>'
		+				'<td width="854" align="left" valign="middle"><h2>체육관</h2></td>'
		+				'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+			'</tr>'
		+		'</table>'		   
		+	'</li>'
		...
		+		'<table width="100%" border="0" cellpadding="5" cellspacing="0">'
		+			'<tr>'
		+				'<td width="10%" align="right" valign="middle"><div class="cls-buildingList-img" ><img src="./img/building_hyungseol.png" width="50" height="50"/></div></td>'
		+					'<td width="854" align="left" valign="middle"><h2>형설관</h2></td>'
		+				'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+			'</tr>'
		+		'</table>'		   
		+	'</li>'	
		...
		+			'<td width="854" align="left" valign="middle" style="padding-left:10px"><h2>1층</h2>'
		+			'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+		'</tr></table>'
		+	'</li>'
		+	'<li class="cls-resultList-floor">'
		+		'<table width="100%" border="0" cellpadding="5" cellspacing="0"><tr>'
		+			'<td width="854" align="left" valign="middle" style="padding-left:10px"><h2>2층</h2>'
		+			'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+		'</tr></table>'
		+	'</li>'
		+	'<li class="cls-resultList-floor">'
		+		'<table width="100%" border="0" cellpadding="5" cellspacing="0"><tr>'
		+			'<td width="854" align="left" valign="middle" style="padding-left:10px"><h2>3층</h2>'
		+			'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+		'</tr></table>'
		+	'</li>'
		+	'<li class="cls-resultList-floor">'
		+		'<table width="100%" border="0" cellpadding="5" cellspacing="0"><tr>'
		+			'<td width="854" align="left" valign="middle" style="padding-left:10px"><h2>4층</h2>'
		+			'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+		'</tr></table>'
		+	'</li>'
		+	'<li class="cls-resultList-floor">'
		+		'<table width="100%" border="0" cellpadding="5" cellspacing="0"><tr>'
		+			'<td width="854" align="left" valign="middle" style="padding-left:10px"><h2>5층</h2>'
		+			'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+		'</tr></table>'
		+	'</li>'
		+	'<li class="cls-resultList-floor">'
		+		'<table width="100%" border="0" cellpadding="5" cellspacing="0"><tr>'
		+			'<td width="854" align="left" valign="middle" style="padding-left:10px"><h2>6층</h2>'
		+			'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+		'</tr></table>'
		+	'</li>'
		+'</ul>'
		...
		+	'<li class="cls-resultList-floor">'
		+		'<table width="100%" border="0" cellpadding="5" cellspacing="0"><tr>'
		+			'<td width="854" align="left" valign="middle" style="padding-left:10px"><h2>지하1층</h2>'
		+			'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+		'</tr></table>'
		+	'</li>'
		+'</ul>'		
		...
		+	'<li class="cls-resultList-floor">'
		+		'<table width="100%" border="0" cellpadding="5" cellspacing="0"><tr>'
		+			'<td width="854" align="left" valign="middle" style="padding-left:10px"><h2>별관2층</h2>'
		+			'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+		'</tr></table>'
		+	'</li>'
		+	'<li class="cls-resultList-floor">'
		+		'<table width="100%" border="0" cellpadding="5" cellspacing="0"><tr>'
		+			'<td width="854" align="left" valign="middle" style="padding-left:10px"><h2>별관3층</h2>'
		+			'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+		'</tr></table>'
		+	'</li>'
		+	'<li class="cls-resultList-floor">'
		+		'<table width="100%" border="0" cellpadding="5" cellspacing="0"><tr>'
		+			'<td width="854" align="left" valign="middle" style="padding-left:10px"><h2>별관4층</h2>'
		+			'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+		'</tr></table>'
		+	'</li>'
		+	'<li class="cls-resultList-floor">'
		+		'<table width="100%" border="0" cellpadding="5" cellspacing="0"><tr>'
		+			'<td width="854" align="left" valign="middle" style="padding-left:10px"><h2>별관지하1층</h2>'
		+			'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+		'</tr></table>'
		+	'</li>'
		+	'<li class="cls-resultList-floor">'
		+		'<table width="100%" border="0" cellpadding="5" cellspacing="0"><tr>'
		+			'<td width="854" align="left" valign="middle" style="padding-left:10px"><h2>별관지하2층</h2>'
		+			'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+		'</tr></table>'
		+	'</li>'
		+'</ul>'		
		...
		+	'<li class="cls-resultList-floor">'
		+		'<table width="100%" border="0" cellpadding="5" cellspacing="0"><tr>'
		+			'<td width="854" align="left" valign="middle" style="padding-left:10px"><h2>A동1층</h2>'
		+			'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+		'</tr></table>'
		+	'</li>'
		+	'<li class="cls-resultList-floor">'
		+		'<table width="100%" border="0" cellpadding="5" cellspacing="0"><tr>'
		+			'<td width="854" align="left" valign="middle" style="padding-left:10px"><h2>A동2층</h2>'
		+			'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+		'</tr></table>'
		+	'</li>'
		+	'<li class="cls-resultList-floor">'
		+		'<table width="100%" border="0" cellpadding="5" cellspacing="0"><tr>'
		+			'<td width="854" align="left" valign="middle" style="padding-left:10px"><h2>B동1층</h2>'
		+			'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+		'</tr></table>'
		+	'</li>'
		+	'<li class="cls-resultList-floor">'
		+		'<table width="100%" border="0" cellpadding="5" cellspacing="0"><tr>'
		+			'<td width="854" align="left" valign="middle" style="padding-left:10px"><h2>B동2층</h2>'
		+			'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+		'</tr></table>'
		+	'</li>'
		+'</ul>'		
		...
		+	'<li class="cls-resultList-floor">'
		+		'<table width="100%" border="0" cellpadding="5" cellspacing="0"><tr>'
		+			'<td width="854" align="left" valign="middle" style="padding-left:10px"><h2>7층</h2>'
		+			'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+		'</tr></table>'
		+	'</li>'
		+	'<li class="cls-resultList-floor">'
		+		'<table width="100%" border="0" cellpadding="5" cellspacing="0"><tr>'
		+			'<td width="854" align="left" valign="middle" style="padding-left:10px"><h2>8층</h2>'
		+			'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+		'</tr></table>'
		+	'</li>'
		+	'<li class="cls-resultList-floor">'
		+		'<table width="100%" border="0" cellpadding="5" cellspacing="0"><tr>'
		+			'<td width="854" align="left" valign="middle" style="padding-left:10px"><h2>9층</h2>'
		+			'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+		'</tr></table>'
		+	'</li>'
		+	'<li class="cls-resultList-floor">'
		+		'<table width="100%" border="0" cellpadding="5" cellspacing="0"><tr>'
		+			'<td width="854" align="left" valign="middle" style="padding-left:10px"><h2>10층</h2>'
		+			'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+		'</tr></table>'
		+	'</li>'
		+	'<li class="cls-resultList-floor">'
		+		'<table width="100%" border="0" cellpadding="5" cellspacing="0"><tr>'
		+			'<td width="854" align="left" valign="middle" style="padding-left:10px"><h2>11층</h2>'
		+			'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+		'</tr></table>'
		+	'</li>'
		+'</ul>'		
		...
		+	'<li class="cls-resultList-floor">'
		+		'<table width="100%" border="0" cellpadding="5" cellspacing="0"><tr>'
		+			'<td width="854" align="left" valign="middle" style="padding-left:10px"><h2>지하2층</h2>'
		+			'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+		'</tr></table>'
		+	'</li>'
		+	'<li class="cls-resultList-floor">'
		+		'<table width="100%" border="0" cellpadding="5" cellspacing="0"><tr>'
		+			'<td width="854" align="left" valign="middle" style="padding-left:10px"><h2>지하3층</h2>'
		+			'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+		'</tr></table>'
		+	'</li>'
		+	'<li class="cls-resultList-floor">'
		+		'<table width="100%" border="0" cellpadding="5" cellspacing="0"><tr>'
		+			'<td width="854" align="left" valign="middle" style="padding-left:10px"><h2>지하중2층</h2>'
		+			'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+		'</tr></table>'
		+	'</li>'
		+'</ul>'
		...
		+	'<li class="cls-resultList-floor">'
		+		'<table width="100%" border="0" cellpadding="5" cellspacing="0"><tr>'
		+			'<td width="854" align="left" valign="middle" style="padding-left:10px"><h2>별관1층</h2>'
		+			'<td width="68" align="right" valign="middle"><span class="cls-buildingList-fov"><img src="./img/favorite_star_gray.png" alt="즐겨찾기에 추가" title="0" width="40px" height="40px"/></span></td>'
		+		'</tr></table>'
		+	'</li>'
		+	'<li class="cls-resultList-floor">'
		...
		for( var i = 0; i < selectorObject_Flg[FAVORITE_FLG].length; i++){
			...
			selectorObject_Flg[FAVORITE_FLG][i].parentElement.addEventListener('click', function( event ){//TD태그에 이벤트를 추가합니다.
				...
				//console.dir( parentList.querySelector("h2") );
				
				
				if( target.title == "0"){//즐겨찾기 추가하기.					
					target.src = "./img/favorite_star.png";
					target.alt = "즐겨찾기에서 제거";
					target.title = "1";						
					console.log("즐겨찾기 추가했습니다.");
				...
				else if( target.title == "1" ){   //즐겨찾기 삭제
					target.src = "./img/favorite_star_gray.png";
					target.alt = "즐겨찾기에 추가";
					target.title = "0";
					console.log("즐겨찾기 해제했습니다.");
	...
	{	
		...
		for( var i =0; i < selectorObject_Flg[FAVORITE_FLG].length; i++){
			selectorObject_Flg[FAVORITE_FLG][i].children[0].src = "./img/favorite_star_gray.png";
			selectorObject_Flg[FAVORITE_FLG][i].children[0].alt = "즐겨찾기에 추가";
			selectorObject_Flg[FAVORITE_FLG][i].children[0].title = "0";
		}
		//alert("지랄이 풍년! 1단계");
		//지랄이풍년 2단계가 안뜬다. 크리티컬 걸려서 작동 안하는것 같다. 아무래도...소스를 분리시켜야될것 같아보인다...지랄 -_-(일단 패키징은 잘되는지 확인해 봅시다.)
		...
		favoriteObject.forEach( function( v ){
			if(v.type == "0"){//favoriteFlagElement_Building 에서만 검색합니다.
				switch (v.classRoom_building){
					case "7호관":	
						selectorObject_Flg[FAVORITE_FLG][0].children[0].src = "./img/favorite_star.png";
						selectorObject_Flg[FAVORITE_FLG][0].children[0].alt = "즐겨찾기에서 삭제";
						selectorObject_Flg[FAVORITE_FLG][0].children[0].title = "1";
						break;
					case "경상관":
						selectorObject_Flg[FAVORITE_FLG][1].children[0].src = "./img/favorite_star.png";
						selectorObject_Flg[FAVORITE_FLG][1].children[0].alt = "즐겨찾기에서 삭제";
						selectorObject_Flg[FAVORITE_FLG][1].children[0].title = "1";
						break;
					case "공학관":
						selectorObject_Flg[FAVORITE_FLG][2].children[0].src = "./img/favorite_star.png";
						selectorObject_Flg[FAVORITE_FLG][2].children[0].alt = "즐겨찾기에서 삭제";
						selectorObject_Flg[FAVORITE_FLG][2].children[0].title = "1";
						break;
					case "과학관":
						selectorObject_Flg[FAVORITE_FLG][3].children[0].src = "./img/favorite_star.png";
						selectorObject_Flg[FAVORITE_FLG][3].children[0].alt = "즐겨찾기에서 삭제";
						selectorObject_Flg[FAVORITE_FLG][3].children[0].title = "1";
						break;
					case "국제관":
						selectorObject_Flg[FAVORITE_FLG][4].children[0].src = "./img/favorite_star.png";
						selectorObject_Flg[FAVORITE_FLG][4].children[0].alt = "즐겨찾기에서 삭제";
						selectorObject_Flg[FAVORITE_FLG][4].children[0].title = "1";
						break;
					case "법학관":
						selectorObject_Flg[FAVORITE_FLG][5].children[0].src = "./img/favorite_star.png";
						selectorObject_Flg[FAVORITE_FLG][5].children[0].alt = "즐겨찾기에서 삭제";
						selectorObject_Flg[FAVORITE_FLG][5].children[0].title = "1";
						break;
					case "복지관":
						selectorObject_Flg[FAVORITE_FLG][6].children[0].src = "./img/favorite_star.png";
						selectorObject_Flg[FAVORITE_FLG][6].children[0].alt = "즐겨찾기에서 삭제";
						selectorObject_Flg[FAVORITE_FLG][6].children[0].title = "1";
						break;
					case "북악관":
						selectorObject_Flg[FAVORITE_FLG][7].children[0].src = "./img/favorite_star.png";
						selectorObject_Flg[FAVORITE_FLG][7].children[0].alt = "즐겨찾기에서 삭제";
						selectorObject_Flg[FAVORITE_FLG][7].children[0].title = "1";
						break;
					case "예술관":
						selectorObject_Flg[FAVORITE_FLG][8].children[0].src = "./img/favorite_star.png";
						selectorObject_Flg[FAVORITE_FLG][8].children[0].alt = "즐겨찾기에서 삭제";
						selectorObject_Flg[FAVORITE_FLG][8].children[0].title = "1";
						break;
					case "조형관":
						selectorObject_Flg[FAVORITE_FLG][9].children[0].src = "./img/favorite_star.png";
						selectorObject_Flg[FAVORITE_FLG][9].children[0].alt = "즐겨찾기에서 삭제";
						selectorObject_Flg[FAVORITE_FLG][9].children[0].title = "1";
						break;
					case "체육관":
						selectorObject_Flg[FAVORITE_FLG][10].children[0].src = "./img/favorite_star.png";
						selectorObject_Flg[FAVORITE_FLG][10].children[0].alt = "즐겨찾기에서 삭제";
						selectorObject_Flg[FAVORITE_FLG][10].children[0].title = "1";
						break;
					case "형설관":
						selectorObject_Flg[FAVORITE_FLG][11].children[0].src = "./img/favorite_star.png";
						selectorObject_Flg[FAVORITE_FLG][11].children[0].alt = "즐겨찾기에서 삭제";
						selectorObject_Flg[FAVORITE_FLG][11].children[0].title = "1";
						break;
				}
			}
					...
					case "7호관":	
						...
						for( var i=0; i < selected_favoriteFlagElement.length; i++){
							if( v.classRoom_floor == strTemp){								
								selected_favoriteFlagElement[i].children[0].src = "./img/favorite_star.png";
								selected_favoriteFlagElement[i].children[0].alt = "즐겨찾기에서 제거";
								selected_favoriteFlagElement[i].children[0].title = "1";		
							}
						}
						break;
					case "경상관":
						...
						var strTemp = strTemp ? selected_favoriteFlagElement[i].parentElement.parentElement.querySelector("h2").innerText : selected_favoriteFlagElement[i].parentElement.parentElement.querySelector("h2").textContent;
